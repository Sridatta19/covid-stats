...
exports.dateReducer = exports.getReverseStateMappings = exports.getStateCodes = exports.createDefaultEntry = exports.createEntry = exports.funkyGrouper = exports.groupByMulti = exports.groupBy = exports.isNotNearDate = exports.formatDate = exports.getPastDates = exports.safeGet = void 0;
...
var funkyGrouper = function (list, grouper1, grouper2) {
    var result = list.reduce(function (acc, elem) {
        var _a, _b;
        var key1 = grouper1(elem);
        var key2 = grouper2(elem);
        if (acc[key1] !== undefined) {
            acc[key1] = __assign(__assign({}, acc[key1]), (_a = {}, _a[key2] = elem, _a));
        }
        else {
            acc[key1] = (_b = {},
                _b[key2] = elem,
...
exports.funkyGrouper = funkyGrouper;
...
var dateReducer = function (data, masterData, propertyArray) { return function (date, index, dates) {
    // Ignore first Entry
    if (index === 0) {
        return;
    }
    // Check if State data exists for each date
    var stateData = exports.safeGet(__spreadArray(__spreadArray([date], propertyArray), ["0"]), masterData);
    var previousData = exports.safeGet(__spreadArray(__spreadArray([dates[index - 1]], propertyArray), ["0"]), masterData);
