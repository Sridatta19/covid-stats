...
import { getCountryEntry, getStateEntry } from "../components/utils/fn-utils"
import { DATA_ENTRY } from "../components/utils/type-definitions"
...
const IndexPage = ({
  ...
  const [data, setData] = useState<DATA_ENTRY[]>(
  ...
  useEffect(() => {
    if (apiResult) {
      ...
      const entry = getCountryEntry(apiResult)
      if (entry) {
